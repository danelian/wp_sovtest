$(document).ready(function () {
  ...
  if (heroFileInput) {
    document.querySelector('.hero .file-inputs').addEventListener('change', function () {
        ...
        var heroFileItem = document.querySelector('.hero .file-upload .file-item')
  ...
  if (ctaFileInput) {
    document.querySelector('.cta .file-inputs').addEventListener('change', function () {
        ...
        var ctaFileItem = document.querySelector('.cta .file-upload .file-item')
  ...
  const modalFileInput = document.querySelector('.modal .file-inputs')
  if (modalFileInput) {
    document.querySelector('.modal .file-inputs').addEventListener('change', function () {
        var modalFileInput = this
        var modalFileItem = document.querySelector('.modal .file-upload .file-item')

        if (modalFileItem) {
          modalFileItem.style.display = 'block'
        } else {
          modalFileItem = document.createElement('div')
          modalFileItem.classList.add('file-item')

          var modalDeleteButton = document.createElement('button')
          modalDeleteButton.classList.add('file-delete')
          modalDeleteButton.innerHTML =
            '<svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg"><circle cx="8" cy="8" r="8" fill="#5B534D"/><path d="M8.00035 7.29325L10.4752 4.81836L11.1823 5.52546L8.70745 8.00035L11.1823 10.4752L10.4752 11.1823L8.00035 8.70745L5.52546 11.1823L4.81836 10.4752L7.29325 8.00035L4.81836 5.52546L5.52546 4.81836L8.00035 7.29325Z" fill="white"/></svg>'
          modalDeleteButton.addEventListener('click', function () {
            modalFileInput.value = ''
            modalFileItem.style.display = 'none'
          })

          var modalFileItemIcon = document.createElement('div')
          modalFileItemIcon.classList.add('file-item-icon')

          modalFileItem.appendChild(modalDeleteButton)
          modalFileItem.appendChild(modalFileItemIcon)

          var modalFileUpload = document.querySelector('.modal .file-upload')
          modalFileUpload.appendChild(modalFileItem)
        }
      })
  }
